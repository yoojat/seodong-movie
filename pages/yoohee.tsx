        ...
        <TextContainer>
          <TextContentCol>
            <TextContentRow>
              ...
              <p>
                공연실황, 닌테도 스위치, 스포츠경기, 넷플릭스, 유튜브 등도
                즐겨봐요!
              </p>
              <p>
                혼자서도 방문해주시고, 연인, 친구들도 함께 오셔서 이용하세요.
              </p>
              <p>
          ...
          <TextContentCol>
            <TextContentRow>
              ...
              <p>
                <ul>
                  <li>
                    - 빔프로젝터, 태블릿, 삼각대, 스피커, 냉난방기,
                    스튜디오조명, 촬영소품, 3인용 쇼파 등
                  </li>
                  <li>- 와인잔, 와인오프너, 전자렌지, 냄비, 수저, 가위 등</li>
                </ul>
                <br />
                <br />
                <br />
              ...
              <p>
                <ul>
                  ...
                  <li>- 내부에 화장실이 있습니다.</li>
                  <li>
                    - 리뷰 작성시, 차량 1대 주차 지원(영수증 확인) 혹은 30분
                    추가 이용을 도와드립니다. 주차는 서동 제2공영주차장에
                    해주세요!
                  </li>
                </ul>
